...
use App\Http\Controllers\Api\ExtractorProductInformationController;
...
Route::middleware('api.token')->group(function () {
    ...
    Route::group(['prefix' => 'agents'], function () {
        ...
        Route::group(['prefix' => 'extract-product'], function () {
            Route::post('/', [ExtractorProductInformationController::class, 'extract'])->name('agents.extract-product.extract');
        });
    });
});
